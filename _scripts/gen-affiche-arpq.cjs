...
const T = {
  fr: {
    ...
    big: "0 $ pour toi", bigLabel: "INCLUS AVEC TON ADHÉSION ARPQ",
    bigSub1: "Tu ne paies jamais la clinique. Peu importe le nombre de consultations.",
    bigSub2: "Famille (18 ans et plus) : ajoutable via l’ARPQ, aux mêmes conditions. Français · Español · English.",
    strip: "CE QUE ÇA TE COÛTE — RIEN. L’ARPQ PREND TOUT EN CHARGE",
    cells: [["0 $", "PAYÉ PAR LE MEMBRE"], ["Illimité", "CONSULTATIONS"], ["Famille", "18 ANS ET PLUS, VIA L’ARPQ"], ["90 j", "DE GRÂCE SI ÇA SE TERMINE"]],
    stripNote: "L’inscription passe par l’ARPQ, qui prend en charge la couverture de ses membres — la clinique ne facture jamais les membres. Couverture maintenue 90 jours après un retrait.",
    ...
    incl: [["Urgences mineures et dépistage", "infections, peau, reflux, diabète, thyroïde…"], ["Douleur musculosquelettique", "dos, cou, épaule, entorses…"], ["Santé mentale", "anxiété, insomnie, épuisement…"], ["Documents d’arrêt de travail (congés)", ""], ["Formulaires d’assurance", ""], ["Attestations d’aptitude", ""], ["Évaluations de retour au travail", ""], ["Références vers spécialistes", ""], ["Requêtes d’imagerie", "radiographie, échographie, IRM…"], ["Prises de sang et laboratoires", ""], ["Suivis", ""], ["Partout sur la route", "aucun déplacement, aucune file"]],
    family: ["FAMILLE SUR DEMANDE", "demande à l’ARPQ d’ajouter les membres de ta famille de 18 ans et plus — couverts aux mêmes conditions que toi."],
    rating: "4,4 / 5 · 183 avis Google", ratingSub: "Centre Médical Font (M28) · m28.ca",
    footKicker: "INSCRIPTION — MEMBRES ARPQ", footLine: "Dr Carlos Font, médecin de famille — Truck Stop Santé · Centre Médical Font — permis CMQ 16812 · Examens SAAQ : m28.ca",
  ...
  en: {
    ...
    big: "$0 for you", bigLabel: "INCLUDED WITH YOUR ARPQ MEMBERSHIP",
    bigSub1: "You never pay the clinic. However many consultations you need.",
    bigSub2: "Family (18 and over): can be added through the ARPQ, on the same terms. Français · Español · English.",
    strip: "WHAT IT COSTS YOU — NOTHING. THE ARPQ COVERS IT ALL",
    cells: [["$0", "PAID BY THE MEMBER"], ["Unlimited", "CONSULTATIONS"], ["Family", "18 AND OVER, THROUGH THE ARPQ"], ["90 d", "OF GRACE IF IT ENDS"]],
    stripNote: "Enrolment goes through the ARPQ, which covers its members — the clinic never bills members. Coverage kept 90 days after removal.",
    ...
    incl: [["Minor urgent care and screening", "infections, skin, reflux, diabetes, thyroid…"], ["Musculoskeletal pain", "back, neck, shoulder, sprains…"], ["Mental health", "anxiety, insomnia, burnout…"], ["Sick-leave documentation", ""], ["Insurance forms", ""], ["Fitness-for-duty attestations", ""], ["Return-to-work evaluations", ""], ["Referrals to specialists", ""], ["Imaging requisitions", "X-ray, ultrasound, MRI…"], ["Blood work and labs", ""], ["Follow-ups", ""], ["Anywhere on the road", "no travel, no queue"]],
    family: ["FAMILY ON REQUEST", "ask the ARPQ to add your family members aged 18 and over — covered on the same terms as you."],
    rating: "4.4 / 5 · 183 Google reviews", ratingSub: "Centre Médical Font (M28) · m28.ca",
    footKicker: "ENROLMENT — ARPQ MEMBERS", footLine: "Dr Carlos Font, family physician — Truck Stop Santé · Centre Médical Font — CMQ licence 16812 · SAAQ exams: m28.ca",
